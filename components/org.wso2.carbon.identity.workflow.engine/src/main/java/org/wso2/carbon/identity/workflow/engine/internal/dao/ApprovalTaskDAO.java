...
public interface ApprovalTaskDAO {
     ...
     */
    void deleteApprovalTasksExceptGivenApprovalTaskId(String workflowRequestId, String workflowId,
     ...
     * @param approvalTaskId The approval task ID that need to be excluded when deleting.
     */
    void deleteApprovalTasksExceptGivenApprovalTaskId(String workflowRequestId, String approvalTaskId)
