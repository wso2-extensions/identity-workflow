...
public class WorkflowEngineConstants {
    ...
    public static class SqlQueries {
        ...
        public static final String DELETE_APPROVAL_TASKS_OF_GIVEN_WORKFLOW_REQUEST_EXCLUDING_UPDATED_TASK_ID =
                "DELETE FROM WF_WORKFLOW_APPROVAL_RELATION WHERE EVENT_ID = ? AND WORKFLOW_ID = ? AND TASK_ID != ?";
        public static final String DELETE_APPROVAL_TASKS_EXCLUDING_UPDATED_TASK_ID = "DELETE FROM " +
                "WF_WORKFLOW_APPROVAL_RELATION WHERE EVENT_ID = ? AND TASK_ID != ?";
        ...
        public static final String GET_RELATIONSHIP_ID_BY_REQUEST_ID_AND_WORKFLOW_ID = "SELECT RELATIONSHIP_ID FROM " +
                "WF_WORKFLOW_REQUEST_RELATION WHERE REQUEST_ID = ? AND WORKFLOW_ID = ?";
        public static final String GET_RELATIONSHIP_IDS_BY_REQUEST_ID = "SELECT RELATIONSHIP_ID FROM " +
